        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xs bg-blue-100 dark:bg-blue-950 text-blue-600 dark:text-blue-400 px-2 py-1 rounded">
                DEMO
              </span>
            </div>
            <Link href="/">
              ...
              <CardContent>
                <div className="space-y-4">
                  {activeSpecs.map((spec) => (
                    <div
                      key={spec.id}
                      className="block p-4 rounded-lg border border-zinc-200 dark:border-zinc-800 hover:border-zinc-300 dark:hover:border-zinc-700 hover:bg-zinc-50 dark:hover:bg-zinc-900 transition-colors cursor-pointer"
                    >
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-blue-700 dark:text-blue-300">
                    This is a demo dashboard showing the Claudester UI with sample data.
                    To use the full application with authentication, configure your Clerk API keys in the <code className="bg-blue-100 dark:bg-blue-900 px-1 rounded">.env</code> file and access <code className="bg-blue-100 dark:bg-blue-900 px-1 rounded">/dashboard</code>.
                  </p>
                </div>
              </div>
            </CardContent>
